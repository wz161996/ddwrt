...
#curl -k -o /tmp/racaljk https://raw.githubusercontent.com/racaljk/hosts/master/dnsmasq.conf
#echo
...
curl -k https://raw.githubusercontent.com/vokins/yhosts/master/hosts.txt -o /tmp/yhosts.conf
echo
echo -e "\e[1;36m 下载malwaredomainlist规则\e[0m"
curl -k http://www.malwaredomainlist.com/hostslist/hosts.txt -o /tmp/mallist
sed -i "s/.$//g" /tmp/mallist
echo
echo -e "\e[1;36m 下载adaway规则缓存\e[0m"
curl -k https://adaway.org/hosts.txt -o /tmp/adaway
curl -k http://winhelp2002.mvps.org/hosts.txt -o /tmp/adaway2
sed -i "s/.$//g" /tmp/adaway2
curl -k http://77l5b4.com1.z0.glb.clouddn.com/hosts.txt -o /tmp/adaway3
curl -k https://hosts-file.net/ad_servers.txt -o /tmp/adaway4
sed -i "s/.$//g" /tmp/adaway4
#curl -k -o /tmp/adaway5 https://pgl.yoyo.org/adservers/serverlist.php?showintro=0;hostformat=hosts
...
curl -k https://raw.githubusercontent.com/clion007/dnsmasq/master/fqad_auto.sh -o /etc/dnsmasq/fqad_auto.sh
